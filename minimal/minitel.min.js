...
"use strict";var Minitel=Minitel||{};Minitel.VDU=class{constructor(t,i,e,s,r){this.grid=t,this.char=i,this.canvas=e,this.context=this.createContext(),this.statusCharacter=70,this.globalMask=!0;const n=[];range(this.grid.rows).forEach((()=>n.push(!1))),this.cursor=new Minitel.VDUCursor(t,i,r),this.vram=new Minitel.VRAM(t),this.lastblink=this.getBlink(),this.blinking=n.map((()=>!1)),this.changed=n.map((()=>!0)),this.font={G0:this.loadFont("font/ef9345-g0.png"),G1:this.loadFont("font/ef9345-g1.png"),G0d:this.loadFont("font/blank.png"),G1d:this.loadFont("font/blank.png")},this.changeColors(s),this.refresh=window.setInterval((()=>{this.render();const t=this.vram.get(this.cursor.x,this.cursor.y);this.cursor.setColor(this.colors[t.fgColor])}),20)}redraw(t){void 0===t?this.changed=this.changed.map((()=>!0)):this.changed[t]=!0}setStatusCharacter(t){this.statusCharacter=t}set(t,i,e){this.vram.set(t,i,e),this.changed[i]=!0}get(t,i){return this.vram.get(t,i)}clear(){this.vram.clear(),this.redraw()}scroll(t){this.vram.scroll(t),this.redraw()}getBlink(){return(new Date).getTime()%1500>=750}createContext(){const t=this.canvas.getContext("2d");return t.imageSmoothingEnabled=!1,t.fillStyle="#000000",t.fillRect(0,0,this.char.width*this.grid.cols,this.char.height*this.grid.rows),t}loadFont(t){return new Minitel.FontSprite(t,{cols:8,rows:16},this.char)}defineCharG0(t,i){this.font.G0d.defineChar(t,i),this.redraw()}defineCharG1(t,i){this.font.G1d.defineChar(t,i),this.redraw()}setGlobalMask(t){this.globalMask=t,this.redraw()}changeColors(t){this.colors=t?Minitel.colors:Minitel.grays;for(let i in this.font)this.font.hasOwnProperty(i)&&(this.font[i].color=t);this.redraw()}generateThumbnail(t,i){const e=document.createElement("canvas");e.width=t,e.height=i;const s=e.getContext("2d");return s.imageSmoothingEnabled=!1,s.drawImage(this.canvas,0,0,t,i),e.toDataURL("image/png")}render(){if(!(this.font.G0.isReady&&this.font.G1.isReady&&this.font.G0d.isReady&&this.font.G1d.isReady))return;const t=new Minitel.CharCell;t.value=this.statusCharacter,t.invert=!0,this.vram.set(38,0,t);const i=this.getBlink();range(0,this.grid.rows).forEach((t=>{if(!(this.changed[t]||this.blinking[t]&&this.lastBlink!==i))return;this.changed[t]=!1;let e=this.drawRow(this.vram.get(t),t,i);this.blinking[t]=e})),this.lastBlink=i}drawRow(t,i,e){let s=0,r=!1,n=!1;const h=i*this.char.height;let a=!1;return range(0,this.grid.cols).forEach((i=>{const o=t[i],l=i*this.char.width;o instanceof Minitel.CharCell||(s=o.bgColor,n=!1),o instanceof Minitel.DelimiterCell||!0!==o.blink||(a=!0);let c=7,d=0;o instanceof Minitel.MosaicCell||!0!==o.invert?[c,d]=[o.fgColor,s]:[c,d]=[s,o.fgColor],this.drawCharacter(l,h,o,c,d,r,e,n),o instanceof Minitel.DelimiterCell&&(void 0!==o.mask&&(r=this.globalMask&&o.mask),void 0!==o.zoneUnderline&&(n=o.zoneUnderline))})),a}drawCharacter(t,i,e,s,r,n,h,a){const o=this.context;if(o.fillStyle=this.colors[r],o.fillRect(t,i,this.char.width,this.char.height),n)return;if(!(e instanceof Minitel.DelimiterCell)&&e.blink&&h===(e instanceof Minitel.MosaicCell||!e.invert))return;let l,c={x:0,y:0},d={width:1,height:1},g=!1;e instanceof Minitel.CharCell?(l=e.drcs?this.font.G0d:this.font.G0,c=e.part,d=e.mult,g=a):e instanceof Minitel.DelimiterCell?(l=e.drcs?this.font.G0d:this.font.G0,d=e.mult,g=a):l=e.drcs?this.font.G1d:this.font.G1,l.writeChar(o,e.value,t,i,c,d,s,g)}getWordAt(t,i){const e=Math.floor(t*this.grid.cols/this.canvas.offsetWidth),s=Math.floor(i*this.grid.rows/this.canvas.offsetHeight);return this.vram.getWordAt(e,s)}};
